...
public class GameSpace extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlWelcomeLogIn = new CustomRoundedPanel(80);
        pnlLogInBorder = new CustomRoundedPanel(80);
        pnlLogIn = new CustomRoundedPanel(70);
        ...
        pnlTotalFreeGames = new CustomRoundedPanel(80);
        ...
        lblCurrentlyPlaying.setText("IDLE");
        lblCurrentlyPlaying.setAutoscrolls(true);
